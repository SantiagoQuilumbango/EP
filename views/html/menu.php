<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
    <li class="menu-item">
        <a href="departamento/departamento.views.php" target="base" class="menu-link">
            <?php $_SESSION['rutas'] = 'Departamento'; ?>
            <div data-i18n="Without navbar">Departamento</div>
        </a>
    </li>
    <li class="menu-item">
        <a href="empleado/empleado.views.php" target="base" class="menu-link">
            <?php $_SESSION['rutas'] = 'Empleado'; ?>
            <div data-i18n="Without navbar">Empleado</div>
        </a>
    </li>
    <li class="menu-item">
